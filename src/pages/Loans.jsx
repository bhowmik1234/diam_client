...
const Loan = () => {
  ...
  useEffect(() => {
    if (!walletAddress) {
      ...
      setConnected(true);
      axios.post(`${import.meta.env.VITE_BACKEND_URL}/loan/historyRead`, { address: walletAddress })
        .then((res) => {
          const obj = res.data;
  ...
  const handleProceed = async () => {
    ...
    try {
      ...
      const res = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/make-payment`,{
      ...
      axios.post(`${import.meta.env.VITE_BACKEND_URL}/loan/historyWrite`,{ 
